...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.post(data).then(ui.onAddUserSuccess).catch(ui.onAddUserFailure);
	};

	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.postSignIn(data).then(ui.onSignInSuccess).catch(ui.onSignInFailure);
	};
	...
	var postSignInSuccess = function postSignInSuccess(data) {
	...
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signOut(onSignIn.data).then(ui.signOutSuccess).catch(ui.signOutFailure);
	};
	...
	var postCreateGameSuccess = function postCreateGameSuccess(data) {
	  store.game = data.game;
	};

	// Event handlers to respond to users clicking on game cells

	var onClickCellZero = function onClickCellZero(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  ...
	  if (store.game.cells[0] === '') {
	    ...
	    api.clickedCellZero().then(ui.clickedCellZeroSuccess).catch(ui.clickedCellZeroFailure);
	  } else {
	    if (store.game.cells[0] !== '') {
	      ui.clickedFullCell();
	    }
	...
	var onClickCellOne = function onClickCellOne(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[1] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellOne().then(ui.clickedCellOneSuccess).catch(ui.clickedCellOneFailure);
	  }
	};
	var onClickCellTwo = function onClickCellTwo(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[2] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellTwo().then(ui.clickedCellTwoSuccess).catch(ui.clickedCellTwoFailure);
	  }
	};

	var onClickCellThree = function onClickCellThree(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[3] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellThree().then(ui.clickedCellThreeSuccess).catch(ui.clickedCellThreeFailure);
	  }
	};

	var onClickCellFour = function onClickCellFour(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[4] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellFour().then(ui.clickedCellFourSuccess).catch(ui.clickedCellFourFailure);
	  }
	};

	var onClickCellFive = function onClickCellFive(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[5] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellFive().then(ui.clickedCellFiveSuccess).catch(ui.clickedCellFiveFailure);
	  }
	};

	var onClickCellSix = function onClickCellSix(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[6] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellSix().then(ui.clickedCellSixSuccess).catch(ui.clickedCellSixFailure);
	  }
	};

	var onClickCellSeven = function onClickCellSeven(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[7] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellSeven().then(ui.clickedCellSevenSuccess).catch(ui.clickedCellSevenFailure);
	  }
	};

	var onClickCellEight = function onClickCellEight(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (store.game.cells[8] !== '') {
	    ui.clickedFullCell();
	  } else {
	    api.clickedCellEight().then(ui.clickedCellEightSuccess).catch(ui.clickedCellEightFailure);
	  }
	};
	...
	module.exports = {
	  onSignUp: onSignUp,
	  onSignIn: onSignIn,
	  postSignInSuccess: postSignInSuccess,
	  onSignOut: onSignOut,
	  onChangePassword: onChangePassword,
	  onCreateGame: onCreateGame,
	  postCreateGameSuccess: postCreateGameSuccess,
	  onClickCellZero: onClickCellZero,
	  onClickCellOne: onClickCellOne,
	  onClickCellTwo: onClickCellTwo,
	  onClickCellThree: onClickCellThree,
	  onClickCellFour: onClickCellFour,
	  onClickCellFive: onClickCellFive,
	  onClickCellSix: onClickCellSix,
	  onClickCellSeven: onClickCellSeven,
	  onClickCellEight: onClickCellEight,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var postSignIn = function postSignIn(data) {
	  return $.ajax({
	...
	var clickedCellZero = function clickedCellZero() {
	  if (store.counter === 0) {
	    store.player = 'X';
	  } else {
	    if (store.counter % 2) {
	...
	var clickedCellOne = function clickedCellOne() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var clickedCellTwo = function clickedCellTwo() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var clickedCellThree = function clickedCellThree() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var clickedCellFour = function clickedCellFour() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var clickedCellFive = function clickedCellFive() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var clickedCellSix = function clickedCellSix() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var clickedCellSeven = function clickedCellSeven() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var clickedCellEight = function clickedCellEight() {
	  store.player = 'X';
	  if (store.counter % 2) {
	    store.player = 'X';
	    store.counter++;
	...
	var getIndex = function getIndex(data) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  clickedCellZero: clickedCellZero,
	  clickedCellOne: clickedCellOne,
	  clickedCellTwo: clickedCellTwo,
	  clickedCellThree: clickedCellThree,
	  clickedCellFour: clickedCellFour,
	  clickedCellFive: clickedCellFive,
	  clickedCellSix: clickedCellSix,
	  clickedCellSeven: clickedCellSeven,
	  clickedCellEight: clickedCellEight,
	  gameLost: gameLost,
	  gameWon: gameWon,
	  gameDraw: gameDraw,
	  getIndex: getIndex
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  store: store,
	  gameLostStats: gameLostStats,
	  gameWonStats: gameWonStats,
	  gameDrawStats: gameDrawStats
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	;var onAddUserSuccess = function onAddUserSuccess(response) {
	  // console.log('yayyyyy we did it')
	  // console.log(response)
	  $('#addUserSuccessPrompt').text('You have signed up!');
	};

	var onAddUserFailure = function onAddUserFailure(response) {
	...
	var createGameSuccess = function createGameSuccess(response) {
	  ...
	  // console.log(response)
	  // console.log(store.game.cells)
	  if (store.game.cells[0] !== '' && store.game.cells[1] !== '' && store.game.cells[2] !== '' && store.game.cells[3] !== '' && store.game.cells[4] !== '' && store.game.cells[5] !== '' && store.game.cells[6] !== '' && store.game.cells[7] !== '' && store.game.cells[8] !== '') {
	    $('#cellZero').text('T');
	    $('#cellOne').text('I');
	    $('#cellTwo').text('C');
	    $('#cellThree').text('T');
	...
	var createGameFailure = function createGameFailure(response) {
	  // console.log('Boo, it failed')
	  // console.log(response)
	  // console.log('store.user console log data is ' + store.user)
	...
	var clickedCellZeroSuccess = function clickedCellZeroSuccess(response) {
	...
	var clickedCellZeroFailure = function clickedCellZeroFailure(error) {
	...
	var clickedCellOneSuccess = function clickedCellOneSuccess(response) {
	...
	var clickedCellOneFailure = function clickedCellOneFailure(error) {
	...
	var clickedCellTwoSuccess = function clickedCellTwoSuccess(response) {
	...
	var clickedCellTwoFailure = function clickedCellTwoFailure(error) {
	...
	var clickedCellThreeSuccess = function clickedCellThreeSuccess(response) {
	...
	var clickedCellThreeFailure = function clickedCellThreeFailure(error) {
	...
	var clickedCellFourSuccess = function clickedCellFourSuccess(response) {
	...
	var clickedCellFourFailure = function clickedCellFourFailure(error) {
	...
	var clickedCellFiveSuccess = function clickedCellFiveSuccess(response) {
	...
	var clickedCellFiveFailure = function clickedCellFiveFailure(error) {
	...
	var clickedCellSixSuccess = function clickedCellSixSuccess(response) {
	...
	var clickedCellSixFailure = function clickedCellSixFailure(error) {
	...
	var clickedCellSevenSuccess = function clickedCellSevenSuccess(response) {
	...
	var clickedCellSevenFailure = function clickedCellSevenFailure(error) {
	...
	var clickedCellEightSuccess = function clickedCellEightSuccess(response) {
	  // console.log('User clicked Cell Two and turn completed')
	  // console.log(response)
	  store.game = response.game;
	  // console.log('store.game console.log data is: ' + store.game)
	...
	var clickedCellEightFailure = function clickedCellEightFailure(error) {
	...
	var clickedFullCell = function clickedFullCell(response) {
	...
	var placeholder = function placeholder(response) {}
	...
	;var winsGame = function winsGame() {
	  if (store.game.cells[0] === 'X' && store.game.cells[1] === 'X' && store.game.cells[2] === 'X' || store.game.cells[3] === 'X' && store.game.cells[4] === 'X' && store.game.cells[5] === 'X' || store.game.cells[6] === 'X' && store.game.cells[7] === 'X' && store.game.cells[8] === 'X' || store.game.cells[0] === 'X' && store.game.cells[3] === 'X' && store.game.cells[6] === 'X' || store.game.cells[1] === 'X' && store.game.cells[4] === 'X' && store.game.cells[7] === 'X' || store.game.cells[2] === 'X' && store.game.cells[5] === 'X' && store.game.cells[8] === 'X' || store.game.cells[0] === 'X' && store.game.cells[4] === 'X' && store.game.cells[8] === 'X' || store.game.cells[2] === 'X' && store.game.cells[4] === 'X' && store.game.cells[6] === 'X') {
	    ...
	    if (store.game.cells[0] === 'O' && store.game.cells[1] === 'O' && store.game.cells[2] === 'O' || store.game.cells[3] === 'O' && store.game.cells[4] === 'O' && store.game.cells[5] === 'O' || store.game.cells[6] === 'O' && store.game.cells[7] === 'O' && store.game.cells[8] === 'O' || store.game.cells[0] === 'O' && store.game.cells[3] === 'O' && store.game.cells[6] === 'O' || store.game.cells[1] === 'O' && store.game.cells[4] === 'O' && store.game.cells[7] === 'O' || store.game.cells[2] === 'O' && store.game.cells[5] === 'O' && store.game.cells[8] === 'O' || store.game.cells[0] === 'O' && store.game.cells[4] === 'O' && store.game.cells[8] === 'O' || store.game.cells[2] === 'O' && store.game.cells[4] === '' && store.game.cells[6] === 'X') {
	...
	var gameLoseStatsUpdate = function gameLoseStatsUpdate() {
	  $('#userstatslost').text('Lost games: ' + store.gameLostStats);
	};

	var gameWonStatsUpdate = function gameWonStatsUpdate() {
	  $('#userstatswin').text('Won games: ' + store.gameWonStats);
	};

	var gameDrawStatsUpdate = function gameDrawStatsUpdate() {
	  $('#userstatsdraw').text('Draw games: ' + store.gameDrawStats);
	};
	...
	var indexFailure = function indexFailure(response) {
	  // console.log('Boo, it failed')
	  // console.log(response)
	  store.game = response.game;
	  console.log('store.user console log data is ' + store.game);
	...
	module.exports = {
	  ...
	  onAddUserFailure: onAddUserFailure,
	  ...
	  clickedCellZeroSuccess: clickedCellZeroSuccess,
	  clickedCellZeroFailure: clickedCellZeroFailure,
	  clickedCellOneSuccess: clickedCellOneSuccess,
	  clickedCellOneFailure: clickedCellOneFailure,
	  clickedCellTwoSuccess: clickedCellTwoSuccess,
	  clickedCellTwoFailure: clickedCellTwoFailure,
	  clickedCellThreeSuccess: clickedCellThreeSuccess,
	  clickedCellThreeFailure: clickedCellThreeFailure,
	  clickedCellFourSuccess: clickedCellFourSuccess,
	  clickedCellFourFailure: clickedCellFourFailure,
	  clickedCellFiveSuccess: clickedCellFiveSuccess,
	  clickedCellFiveFailure: clickedCellFiveFailure,
	  clickedCellSixSuccess: clickedCellSixSuccess,
	  clickedCellSixFailure: clickedCellSixFailure,
	  clickedCellSevenSuccess: clickedCellSevenSuccess,
	  clickedCellSevenFailure: clickedCellSevenFailure,
	  clickedCellEightSuccess: clickedCellEightSuccess,
	  clickedCellEightFailure: clickedCellEightFailure,
	  clickedFullCell: clickedFullCell,
	  placeholder: placeholder,
	  winsGame: winsGame,
	  gameLoseStatsUpdate: gameLoseStatsUpdate,
	  gameWonStatsUpdate: gameWonStatsUpdate,
	  gameDrawStatsUpdate: gameDrawStatsUpdate,
